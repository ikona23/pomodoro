$(document).ready(function() {
    ...
    $("#start").click(function() {
        ...
        function timer() {
            $(
                "#start, #add5min,#ttl,#time,#min5Break, #min5min,#title2,#breaknum,#add5Break"
            ).hide();
    ...
    $("#reset").click(function() {
        ...
        $("#num").html(count);
        $(
            "#start, #num, #add5min,#ttl,#time,#min5Break,#add5Break,#min5min,#title2,#breaknum"
        ).show();
        $("#reset").hide();
    });
